        ...
        (function (Chart) {
            ...
            Chart.defaults.barFunnel = {
                ...
                region: {
                    ...
                    borderColor: ['#408DBF', '#9A9DDE', '#C784D7' , '#D78487' , '#fb9a99', '#e31a1c', '#fdbf6f', '#ff7f00', '#cab2d6', '#6a3d9a', '#ffff99', '#b15928'],
                    backgroundColor: ['#408DBF', '#9A9DDE', '#C784D7' , '#D78487' , '#fb9a99', '#e31a1c', '#fdbf6f', '#ff7f00', '#cab2d6', '#6a3d9a', '#ffff99', '#b15928'],
                },
            ...
            Chart.controllers.barFunnel = Chart.controllers.bar.extend({
                updateElement: function updateElement(rectangle, index, reset, numBars) {
                    ...
                    var x = reset ? xScale.getPixelForDecimal(0.5) : xScale.getPixelForValue(typeof data === 'object' ? data : NaN, index, this.index);
	            	var y = reset ? yScale.getBasePixel() : yScale.getPixelForValue(data, index, this.index);

                    var vscale = this._getValueScale();
                    var horizontal = vscale.isHorizontal();
                    var ipixels = this.calculateBarIndexPixels(this.index, index, ruler, chartOptions);
                    ...
                    helpers.extend(rectangle, {
                        ...
                        _model: {
                            ...
                            base: reset ? yScalePoint: this.calculateBarValuePixels(this.index , index , chartOptions).base,
                            // width: this.calculateBarWidth(ruler),// old code
                            width : 100,
